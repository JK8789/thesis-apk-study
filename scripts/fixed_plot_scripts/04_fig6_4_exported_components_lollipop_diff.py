...
ax.set_yticks(y)
ax.set_yticklabels([PAIR_LABELS[p] for p in wide["pair_id"]], fontsize=14)
ax.set_xlabel("Difference in exported components (RU - EU)",fontsize=14)
ax.set_title("Difference in exported Android components by matched RU-EU app pair", fontsize=14, pad=12)
