...
for bars in [b1,b2]:
    for b in bars:
        ax.text(b.get_x()+b.get_width()/2, b.get_height()+1, f'{int(b.get_height())}', ha='center', fontsize=14)
ax.set_xticks(x); ax.set_xticklabels(wide.index, fontsize=14)
ax.set_ylabel('Cumulative Maven SDK prefix occurrences', fontsize=14)
